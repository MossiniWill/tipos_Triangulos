...
public class telaTriangulo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/triangulo escaleno.png"))); // NOI18N

        btnVerificar.setText("Verificar");
        btnVerificar.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(102, 102, 102)));
    ...
    private void btnVerificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerificarActionPerformed
        ...
        if (a<b+c && b<a+c && c<a+b){
            ...
            if (a==b && b==c){
                ...
                lblTipo.setText("Triângulo Isócesles");
            } else if (a!=b && b!=c){
